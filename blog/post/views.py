...
from .service_rag import rag_function_perplexity # type: ignore # Importe a função RAG da Perplexity AI
import markdown2
...
def minha_view_rag_perplexity(request): # Nome da view atualizado
    if request.method == 'POST':
        ...
        resposta_html= markdown2.markdown(resposta)
        return render(request, 'template_da_sua_view.html', {'pergunta': user_query, 'resposta_rag': resposta_html})
